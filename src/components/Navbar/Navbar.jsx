...
//           {/* Navigation Links */}
//           <div className="space-y-6 flex justify-center flex-col text-center">
//             {navLinks.map((link) => (
//               <Link 
//                 key={link.href}
//                 href={link.href} 
...
//               </button>
//               <button 
//                 className="block w-full text-[#00ff55] hover:text-[#00ff55db]"
//                 onClick={toggleMobileMenu}
//               >
//                 Settings
//               </button>
...
//     setTheme(newTheme);
//     // Add logic to apply the theme globally if needed
//   };
